...
| __Principal__ | _Metatooth LLC_             | _Swampscott, MA_      | Dec 2018 - present  | Technology for dentists, dental labs, startups, and consumers. | AWS, Bash, BitBucket Pipelines, Browser, eslint, Git, Google Firebase, Heroku, JavaScript, Node, Ruby, ruby-lint, rubocop, Sinatra.rb, Vue.js, WordPress |
