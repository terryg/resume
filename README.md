...
|--------------------|------------------------------|-----------------|-------------|---------------|---------------|
| __VP of Software__ | _Signature Orthodontics Inc_ | _Cambridge, MA_ | Aug 2017 - present | Two (2) direct reports. Created software development plan, defined software architecture, supported 510(k) submittal, prepared production systems for first sale. | JavaScript, Ember.js, three.js, Ruby, C++, Docker, NGINX, Postgresql, Ubuntu, Git, bash, Azure DevOps, Azure |
...
| __Consulting Software Engineer__ | _Astra Tech, Inc_ | _Waltham, MA_ | Jan 2007 - Jul 2010 | Developed RESTful API and C++ client in collaboration with business partner. Industry's first digital workflow for patient-specific dental implant abutments. | Ruby, Rails, Capistrano, Apache, Postgresql, CentOS, Subversion, Bugzilla, Cygwin, bash, rackspace.com |
