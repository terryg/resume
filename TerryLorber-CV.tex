...
Tools & ChatGPT/Claude/Codex/Gemini, CMake, Conan, Docker, Emacs, \\
 & Git, GitHub (Actions, Copilot), Google Cloud Platform, \\
 & Google Docs \& Sheets, Jira, Linear.app, TMUX, WordPress \\
Libraries & CGAL, Clipper2Lib, Eigen, FLTK, GEOS, .NET, Node.js, \\
